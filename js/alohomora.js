/*run the alohomoraMaker function from the other script */
alohomoraAllTheThings(); /* MUST be run before runThing, and will kill any existing event handlers. Run all other event handling AFTER runThing*/
